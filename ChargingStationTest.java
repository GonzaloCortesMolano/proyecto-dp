...
public class ChargingStationTest
{
    ...
    public void testGetCompleteInfo()
    {
        ...
        assertEquals("(ChargingStation: CC01, Cáceres, 0, 10-11)\n(StandardCharger: CC01_003, 80kwh, 0.8€, 0, 0.0€)\n(StandardCharger: CC01_002, 60kwh, 0.6€, 0, 0.0€)\n(StandardCharger: CC01_001, 40kwh, 0.4€, 0, 0.0€)\n(StandardCharger: CC01_000, 20kwh, 0.2€, 0, 0.0€)", otra.getCompleteInfo());
    }
}