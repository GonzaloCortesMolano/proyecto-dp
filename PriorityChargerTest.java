...
/**
 * The test class PriorityChargerTest.
 *
 * @author  (your name)
...
public class PriorityChargerTest
{
    ...
    {
        //Chargers
        charger1 = new PriorityCharger("CH1", 40, 0.25);
        charger2 = new PriorityCharger("CH2", 50, 0.30);
        ...
        //Vehicles
        eVehicle1 = new PriorityEV(Vectalia, locEV1, loc1, "Tesla", "CC12", 50);
        eVehicle2 = new PriorityEV(Vectalia, locEV2, loc2, "Tesla", "CC15", 60);
    ...
    {
        Charger chargerTest = new PriorityCharger("CHTest", 50, 0.50);
